...
Viewer.dialog.ChileIndicaChartWindow = Ext
    .extend(
        Ext.Window, {
            ...
            // crear capa superpuesta con iniciativas filtradas
            georeferenceInitiativesFiltredSuccess: function(responseJson) {
            	var investmentLayer = this._getInvestmentLayerFilter();
            ...
            georeferenceInitiativesSuccess: function(responseJson) {
               ...
               // var responseJson = Ext.util.JSON.decode(jsonExample);
            	//console.log("json a insertar en gis");            	
                            ...
                            fn: function(){              
                                ...
                                if((numAnterior!=numActual)&&(numAnterior!=-1))
                                {
                                	...
                                	if(numActual==context._totalResult){ // se elimina todos los filtros
                                		...
                                		context.georeferenceInitiativesFiltredSuccess(datos);
                                	} 
            ...
            _getInvestmentLayerFilter: function() {
            	var investmentLayers = this.map
                .getLayersByName(this.LAYER_NAME_FILTER);
